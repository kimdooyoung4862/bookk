...
<div class="wrap-main-visual" id="slide">
    <div class="main-visual">
        <ul class="wrap-slide">
                        <li class="slide-img" style="background-image: url(/files/2018/01/05/6f7300fdf55578ec2ef30d90444b96b4.png);">
                <a href="/store/category/12"></a>
            </li>
                        <li class="slide-img" style="background-image: url(/files/2018/01/05/85cbcaf0662f151e6412ed7f8d9d0bf4.png);">
                <a href="/store/category/2"></a>
            </li>
                        <li class="slide-img" style="background-image: url(/files/2018/01/05/e992c569ae7b66a1b2b8797bc01e02b7.png);">
                <a href="/store/category/1"></a>
            </li>
                        <li class="slide-img" style="background-image: url(/files/2018/01/05/136317327609c91d0be3ca5db0e6b39b.png);">
                <a href="/store/category/3"></a>
            </li>
                    </ul>
        <ul class="wrap-dots clearfix">
                        <li><a data-slide-index="0"><button class="btn">따뜻한 겨울</button></a></li>
                        <li><a data-slide-index="1"><button class="btn">겨울, 순백 로맨스</button></a></li>
                        <li><a data-slide-index="2"><button class="btn">나에게 선물, 에세이</button></a></li>
                        <li><a data-slide-index="3"><button class="btn">몸과 마음이 대화하는 시간</button></a></li>
                    </ul>
    </div>
</div>
...
<div class="container">
    <div class="section-ad">
        <div class="ad-item ad-1">
            <a href="http://www.bookk.co.kr/book/view/10894"><img src="/img/banner/banner45.png"/></a>
        </div>
        <div class="ad-item ad-2">
            <a href="http://www.bookk.co.kr/book/view/14564"><img src="/img/banner/banner46.png"/></a>
        </div>
        <div class="ad-item ad-3">
            <a href="http://www.bookk.co.kr/book/view/2438"><img src="/img/banner/banner33.png"/></a>
        </div>
    </div>
    <div class="section-ranking">
        <div class="widget widget-ranking pull-left">
            <div class="widget-header">
                <h3 class="widget-title">이주의 책</h3>
            </div>
    ...
    <div class="section-category">
        <div class="widget widget-ranking">
                        <div class="widget-header">
                <h3 class="widget-title">시·에세이</h3>
                <a href="/store/category/1" class="more">더보기</a>
            </div>
                            ...
                            <a href="/book/view/36625">
                                ...
                                <div class="book-title">양심(良心)</div>
                            </a>
